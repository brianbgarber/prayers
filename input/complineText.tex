...
\begin{hang}
\noindent\makebox[\indt][l]{All:}Our Father, who art in heaven, hallowed be Thy 
...
\begin{hang}
\noindent\makebox[\indt][l]{Priest:}For Thine is the Kingdom and the power and 
...
\begin{hang}
\noindent\makebox[\indt][l]{Reader:}Have mercy on me, O God, according to Thy 
...
\begin{hang}
\noindent\makebox[\indt][l]{Reader:}Glory to God in the highest, and on earth 
...
\begin{hang}
\noindent\makebox[\indt][l]{All:}I believe in one God, the Father Almighty, 
...
\begin{hang}
\noindent\makebox[\indt][l]{Reader:}It is truly meet to bless You, O Theotokos, 
...
\begin{hang}
\noindent\makebox[\indt][l]{Reader:}The memory of the righteous is celebrated 
...
\begin{hang}
\noindent\makebox[\indt][l]{Reader:}Thou who at every season and every hour, in 
...
\begin{hang}
\noindent\makebox[\indt][l]{Priest:}God, be bountiful to us and bless us, show 
...
\begin{hang}
\noindent\makebox[\indt][l]{Priest:}O all-pure and incorruptible Virgin Bride 
...
\begin{hang}
\noindent\makebox[\indt][l]{Reader:}Glory to the Father, and to the 
...
\begin{hang}
\noindent\makebox[\indt][l]{Priest:}O Master, great in mercy, Lord Jesus Christ 
...
\begin{hang}
\noindent\makebox[\indt][l]{Priest:}Let us pray for all Orthodox bishops, for 
our Metropolitan \underline{``          ''}, for the honorable priesthood, the 
diaconate in Christ, and for all the clergy and the people:

\end{hang}

\noindent\makebox[\indt][l]{People:}Lord, have mercy. \textit{(after each 
petition)}
...
\noindent
Beneath Your compassion we take refuge, O Theotokos. Despise not our prayer in 
our necessities, but deliver us from harm, O only pure, only blessed one. Most 
Holy Theotokos, save us! Most Holy Theotokos, save us! Most Holy Theotokos, 
save us!